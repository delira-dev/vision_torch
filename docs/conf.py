...
from deliravision._version import get_versions
import os
import sys
import re
...
project = 'deliravision'
copyright = '2019, Justus Schock, Michael Baumgartner'
...
htmlhelp_basename = 'deliravisiondoc'
...
latex_documents = [
    (master_doc, 'deliravision.tex', 'deliravision Documentation',
     'Justus Schock, Michael Baumgartner', 'manual'),
]
...
man_pages = [
    (master_doc, 'deliravision', 'deliravision Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'deliravision', 'deliravision Documentation',
     author, 'deliravision', 'One line description of project.',
     'Miscellaneous'),
]
