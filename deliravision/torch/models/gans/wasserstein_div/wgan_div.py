from deliravision.models.gans.wasserstein_div.models import Discriminator, \
    Generator
...
class WassersteinDivergenceGAN(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals["discr_wasserstein_divergence"] = loss_div.item()
