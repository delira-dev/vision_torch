...
from deliravision.models.gans.dual.models import Discriminator, GeneratorUNet


class DualGAN(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals.update({
            "gradient_penalty_A": gp_a.item(),
            "gradient_penalty_B": gp_b.item(),
            "discr_real_A": loss_discr_real_a.item(),
            "discr_real_B": loss_discr_real_b.item(),
            "discr_fake_A": loss_discr_fake_a.item(),
            "discr_fake_B": loss_discr_fake_b.item(),
            "total_discr_A": loss_discr_a.item(),
            "total_discr_B": loss_discr_b.item(),
            "gen_adv_A": loss_g_adv_a.item(),
            "gen_adv_B": loss_g_adv_b.item(),
            "total_gen_adv": loss_g_adv.item(),
            "gen_cycle_A": loss_g_cycle_a.item(),
            "gen_cycle_B": loss_g_cycle_b.item(),
            "total_gen_cycle": loss_g_cycle.item(),
