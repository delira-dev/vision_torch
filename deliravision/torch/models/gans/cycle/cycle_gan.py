...
from deliravision.models.gans.cycle.models import GeneratorResNet, \
    Discriminator
from deliravision.models.gans.cycle.buffer import ReplayBuffer
...
class CycleGAN(AbstractPyTorchNetwork):
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals.update({
            "gen_id_a": loss_id_a.item(),
            "gen_id_b": loss_id_b.item(),
            "gen_id_total": loss_identity.item(),
            "gen_adv_a": loss_adv_a.item(),
            "gen_adv_b": loss_adv_b.item(),
            "gen_adv_total": loss_adversarial.item(),
            "gen_cycle_a": loss_cycle_a.item(),
            "gen_cycle_b": loss_cycle_b.item(),
            "gen_cycle_total": loss_cycle.item(),
        ...
        loss_vals.update({
            "discr_a_real": loss_real_a.item(),
            "discr_a_fake": loss_fake_a.item(),
            "discr_a_total": loss_discr_a.item(),
            "discr_b_real": loss_real_b.item(),
            "discr_b_fake": loss_fake_b.item(),
            "discr_b_total": loss_discr_b.item()
        })
