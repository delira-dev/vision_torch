from deliravision.models.gans.conditional.models import Discriminator, \
    Generator
from delira.models import AbstractPyTorchNetwork
import torch


class ConditionalGAN(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals.update({
            "adversarial_gen": loss_gen.item(),
            "discr_fake": loss_discr_fake.item(),
            "discr_real": loss_discr_real.item(),
            "discr_total": loss_discr.item()
        })
