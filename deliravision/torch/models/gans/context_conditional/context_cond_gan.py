import torch
from deliravision.models.gans.context_conditional.models import Discriminator, \
    Generator
from delira.models import AbstractPyTorchNetwork


class ContextConditionalGAN(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals["discr_total"] = loss_discr.item()
