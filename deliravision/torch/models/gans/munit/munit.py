from deliravision.models.gans.munit.models import Encoder, Decoder, \
...
class MUNIT(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals.update({
            "gen_adversarial_A": loss_gan_a.item(),
            "gen_adversarial_B": loss_gan_b.item(),
            "gen_identity_A": loss_id_a.item(),
            "gen_identity_B": loss_id_b.item(),
            "gen_style_A": loss_style_a.item(),
            "gen_style_B": loss_style_b.item(),
            "gen_content_A": loss_content_a.item(),
            "gen_content_B": loss_content_b.item(),
            "gen_cyclic_A": loss_cyc_a.item(),
            "gen_cyclic_B": loss_cyc_b.item(),
        ...
        # log losses for discriminator A
        loss_vals.update({
            "discr_real_a": loss_real_a.item(),
            "discr_fake_a": loss_fake_a.item(),
            "discriminator_a": loss_discr_a.item()
        })
        ...
        # log losses for discriminator B
        loss_vals.update({
            "discr_real_b": loss_real_b.item(),
            "discr_fake_b": loss_fake_b.item(),
            "discriminator_b": loss_discr_b.item()
        })
