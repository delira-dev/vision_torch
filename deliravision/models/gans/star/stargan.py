from deliravision.models.gans.star.models import Discriminator, GeneratorResNet
from delira.models import AbstractPyTorchNetwork

import torch


class StarGAN(AbstractPyTorchNetwork):
    """
    ...
    def closure(model, data_dict: dict, optimizers: dict, losses=None,
        ...
        loss_vals["discr_gradient_penalty"] = discr_gp.item()
        loss_vals["discr_adversarial"] = discr_adv.item()
        loss_vals["discr_classification"] = discr_cls.item()
        ...
        loss_vals["gen_adversarial"] = gen_adv.item()
        loss_vals["gen_classification"] = gen_cls.item()
        loss_vals["gen_reconstruction"] = gen_rec.item()
